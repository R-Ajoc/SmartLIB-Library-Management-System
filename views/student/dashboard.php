...
$total_borrowed_books = count($outstanding_transactions);
...
<body class="dashboard-body">
    ...
    <div class="main-content container mt-5">
        ...
        <div class="row mb-4">
            <div class="col-md-6 col-lg-auto mb-2" style="flex: 0 0 25%;">
                <div class="card shadow border-left-<?= $is_cleared ? 'success' : 'danger' ?> h-80 py-2">
                    <div class="card-body text-center">
                        <div class="text-xs font-weight-bold text-uppercase mb-4">Clearance</div>
            ...
            <div class="col-md-6 col-lg-auto mb-2" style="flex: 0 0 25%;">
                <div class="card shadow border-left-warning h-80 py-2">
                    <div class="card-body text-center">
                        <div class="text-xs font-weight-bold text-uppercase mb-4">Borrowed</div>
            ...
            <div class="col-md-6 col-lg-auto mb-2" style="flex: 0 0 25%;">
                <div class="card shadow border-left-<?= $is_limit_reached ? 'danger' : 'success' ?> h-80 py-2">
                    <div class="card-body text-center">
                        <div class="text-xs font-weight-bold text-uppercase mb-4">Borrow Limit</div>
                        <div class="h5 mb-4 font-weight-bold text-gray-800">
                            <span class="text-<?= $is_limit_reached ? 'danger' : 'success' ?>">
                                <?= $is_limit_reached ? 'MAXED OUT' : $remaining . ' Remaining' ?>
                            </span>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-12 mb-3">
            <h2>Latest Books</h2>
            <p>Browse a few books from our library. <a href="<?= $root_path ?>views/student/student_catalog.php" class="btn btn-sm btn-warning">Go to Library</a></p>
        </div>
