...
if (!empty($rawLoanData)) {
    foreach ($rawLoanData as $loan) {
        ...
        $loanData[] = [
            ...
            'price' => number_format($loan['price'], 2),
            'isOverdue' => $isOverdue
        ];
    }
    ...
    <div class="container mt-5">
        ...
        <div class="alert alert-reminders py-2 mt-4 mb-4">
            ...
            <span class="d-block small">
                1. To clear your account for this semester, please make sure all borrowed books are returned by the end of the term.<br>
                2. Any unreturned books may prevent you from borrowing next semester and may incur penalties applied after the official clearance week.<br>
                3. Lost or damaged books must be paid for at their original price.<br>
                4. Penalties for unreturned, lost, or damaged books will only be applied by library staff after clearance week, and your account must be settled before you can be fully cleared.
            </span>
        </div>
